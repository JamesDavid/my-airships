...
export const SHIPS = {
  ...
  no1: {
    ...
    physics: {
      ...
      gasLift: 3.15, weightBase: 1.5, bagLift: 0.15, bags: 8, fuel: 240, ventRate: 2.5,
  ...
  no2: {
    ...
    physics: {
      thrust: 3.2, dragQ: 0.05, dragL: 0.05, yawRate: 0.5, pitchMax: 0.3,
      gasLift: 3.2, weightBase: 1.52, bagLift: 0.15, bags: 9, fuel: 240, ventRate: 2.5,
  ...
  no3: {
    ...
    physics: {
      ...
      gasLift: 3.2, weightBase: 1.6, bagLift: 0.14, bags: 10, fuel: 260, ventRate: 2.8,
  ...
  no4: {
    ...
    physics: {
      ...
      gasLift: 3.25, weightBase: 1.55, bagLift: 0.15, bags: 8, fuel: 300, ventRate: 2.8,
  ...
  no5: {
    ...
    physics: {
      ...
      gasLift: 3.25, weightBase: 1.55, bagLift: 0.15, bags: 9, fuel: 330, ventRate: 3.2,
  ...
  no6: {
    ...
    physics: {
      ...
      gasLift: 3.25, weightBase: 1.55, bagLift: 0.15, bags: 10, fuel: 360, ventRate: 3.0,
  ...
  no7: {
    ...
    physics: {
      ...
      gasLift: 3.4, weightBase: 1.70, bagLift: 0.15, bags: 8, fuel: 260, ventRate: 3.5,
  ...
  no9: {
    ...
    physics: {
      ...
      gasLift: 3.1, weightBase: 1.62, bagLift: 0.12, bags: 8, fuel: 420, ventRate: 2.2,
  ...
  no10: {
    ...
    physics: {
      ...
      gasLift: 3.5, weightBase: 1.6, bagLift: 0.12, bags: 14, fuel: 360, ventRate: 3.2,
